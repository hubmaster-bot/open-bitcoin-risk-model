...
FEATURES: tuple[Feature, ...] = (
    ...
    Feature("holder_behaviour_research", "Holder Behaviour Research",
            "Research Data", True, "0.10.2",
            "Provider-neutral daily evidence import, provenance, and diagnostic scoring."),
    Feature("capital_flow_research", "Realized Capital Flow Research",
            "Research Data", True, "0.10.3",
            "Provider-neutral capital-flow ingestion, integrity verification, normalization, and research scoring."),
