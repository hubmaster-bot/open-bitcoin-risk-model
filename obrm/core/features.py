...
FEATURES: tuple[Feature, ...] = (
    ...
    Feature("onchain_analytics", "On-Chain Analytics", "Analytics", False, "planned",
            "Selected and normalized on-chain metrics for v0.9.1."),
    Feature("onchain_market_dimension", "On-Chain Market Dimension", "Analytics", False, "planned",
            "Fourth Market Dimension and Composite Risk v2 for v0.9.2."),
